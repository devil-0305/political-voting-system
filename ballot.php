                        ...
                        <div class="h-[32rem] bg-gray-100 dark:bg-gray-800">
                            <div class='container px-6 py-10 mx-auto'>
                                ...
                                if ($row = $result->fetch_assoc()) {
                                    echo " 
                                <h1 class='text-3xl font-semibold text-center text-gray-800 capitalize lg:text-4xl dark:text-white'>" . $row['name'] . "</h1>
                                ...
                                <form method="POST" action="ballot_db.php">
                                    <div class='flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700'>
                                        ...
                                        if ($row = $result->fetch_assoc()) {
                                            echo
                                            " 
                                                <h1 class='mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white'>" . $row['position'] . "</h1>
                                                ...
                                                <section class='radio-section mt-2'>
                                                    <div class='radio-list mb-auto'>
                                                        <div class='radio-item'>
                                                            <input type='radio' name='vote' value='" . $row["name"] . "' id='" . $row["id"] . "' required>
                                        ...
                                        <div class="flex justify-center mt-6">
                                            <button type="submit" name="submit" class="inline-flex items-center justify-center mt-8 mb-4 w-32 px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-purple-500 rounded-md hover:bg-purple-400 focus:outline-none focus:bg-purple-400 focus:ring focus:ring-purple-300 focus:ring-opacity-50">submit</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
