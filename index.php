                        ...
                        <div class="container px-6 py-10 mx-auto -mt-72 sm:-mt-80 md:-mt-96">
                            <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3">
                                <div class="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                                    ...
                                    <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white">NITISH KUMAR</h1>
                                    <p class="mt-2 text-gray-500 capitalize dark:text-gray-300">designer</p>
                                ...
                                <div class="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                                    ...
                                    <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white">PALAK KHANDELWAL</h1>
