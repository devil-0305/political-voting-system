                        ...
                        <div class="container px-6 py-10 mx-auto -mt-72 sm:-mt-60  md:-mt-96">
                            <div class=" gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3">
                                <div class='flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700'>
                                    ...
                                    <a href="logout.php" class="inline-flex items-center justify-center mt-8 mb-4 w-32 px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-purple-500 rounded-md hover:bg-purple-400 focus:outline-none focus:bg-purple-400 focus:ring focus:ring-purple-300 focus:ring-opacity-50">
                                        logout
                                    </a>
                                </div>
                            </div>
